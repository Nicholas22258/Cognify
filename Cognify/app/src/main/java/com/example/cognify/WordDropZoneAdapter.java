...
public class WordDropZoneAdapter extends RecyclerView.Adapter<WordDropZoneAdapter.WordViewHolder> {
    ...
    public WordDropZoneAdapter(Context context, List<String> wordList, OnWordClickListener listener) {
